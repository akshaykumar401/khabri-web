...
const Sussefull = ({text, setIsSuccessOpen}) => {
  ...
  return (
    <div>
      <div className="z-[9999] fixed top-2 left-[50%] translate-x-[-50%] bg-green-400 h-24 text-black  rounded-lg w-[300px] flex items-end justify-end">
        <div className="flex gap-1 w-[95%] h-full bg-slate-700 text-white  rounded-lg">
          <div className="w-[85%]">
            <h2 className="text-2xl font-semibold pl-4 pt-2 text-green-400">SUCCESS.</h2>
